...
export const en = {
  ...
  'settings.intro': 'Sign in to use the hosted model, or bring your own API key.',
  'settings.sectionGeneral': 'General',
  'settings.sectionModel': 'Model',
  'settings.sectionByok': 'Your provider',
  'settings.mode': 'Model source',
  'settings.mode.hosted': 'Pagehand (hosted)',
  'settings.mode.byok': 'Bring your own key',
  'settings.mode.hostedHint': 'Runs on Pagehand — no API key to manage.',
  'settings.mode.byokHint': 'Advanced. Prompts go straight to your provider.',
