...
export const en = {
  ...
  'account.signInHint': 'We’ll email you a sign-in link. Open it in this browser.',
  'account.sent': 'Sign-in link sent to {email}.',
  'account.sentHint': 'Open it in this browser — the link signs in whichever one opens it.',
  'account.useAnother': 'Use a different email',
